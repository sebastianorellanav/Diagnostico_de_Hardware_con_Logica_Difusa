...
x_sistema_refrigeracion = np.arange(0, 10, .1)
x_ram = np.arange(0, 10, .1)
x_procesador  = np.arange(0, 10, .1)
x_placa_madre = np.arange(0,10,.1)
x_memoria_fisica = np.arange(0,10,.1)
x_tarjeta_grafica = np.arange(0,10,.1)
x_fuente_poder = np.arange(0,10,.1)
x_rendimiento = np.arange(0,10,.1)
